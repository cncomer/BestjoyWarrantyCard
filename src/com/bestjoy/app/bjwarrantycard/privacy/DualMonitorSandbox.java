...
public class DualMonitorSandbox extends Service{
	...
	private static DualMonitorSandbox INSTANCE;
	private List<IMonitorCallback> mPhoneStateListeners = new LinkedList<IMonitorCallback>();
	private List<IMonitorCallback> mOutgoingCallbacks = new LinkedList<IMonitorCallback>();
	private List<IMonitorCallback> mSmsMonitorCallbacks = new LinkedList<IMonitorCallback>(); 
...
//    		}
	...
	public static Intent getMonitorCallServiceInitIntent(Context context) {
		Intent callMonitorSvr = new Intent(context, DualMonitorSandbox.class);
